...
export default function RecoveryKeyModal({ recoveryKey, onConfirmed }: RecoveryKeyModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4">
      <div className="bg-navy-800 border border-navy-700 rounded-2xl p-6 max-w-md w-full space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="font-bold text-white text-base">Save your recovery key</h2>
        ...
        {/* The key */}
        <div className="bg-navy-900 border border-navy-600 rounded-xl px-4 py-4 text-center">
          <p className="text-white font-mono text-lg font-bold tracking-widest select-all">
            {recoveryKey}
          </p>
        </div>
        ...
        <div className="flex gap-2">
          <button
            onClick={handleCopy}
            className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-navy-700 hover:bg-navy-600 text-white rounded-lg text-sm font-medium transition-colors"
          >
